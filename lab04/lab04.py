...
def double_eights(n):
    ...
    if n < 100:
        ...
        last1, last2 = n // 10 % 10, n % 10
        return (last1 == 8 and last2 == 8) or double_eights(n // 10) 
...
def count_palindromes(L):
    ...
    2
    """
   # return len((lambda l: [x for x in l if x.lower() == x[::-1].lower()])(L)) 
