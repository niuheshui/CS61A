...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    i, num_sum, flag = 1, 0, False
    while i <= num_rolls:
        num = dice()
        if num == 1:
            flag = True
        i, num_sum = i + 1, num_sum + num

    return 1 if flag else num_sum
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    res = abs((opponent_score // 10 % 10) - player_score % 10) * 3 
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def allways_roll_n(*args):
        return n
    return allways_roll_n
    # END PROBLEM 6
